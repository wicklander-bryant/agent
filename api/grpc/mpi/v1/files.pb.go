...
const file_mpi_v1_files_proto_rawDesc = "" +
	...
	"\fip_addresses\x18\x02 \x03(\tR\vipAddresses\"\xaa\x04\n" +
	"\bX509Name\x12(\n" +
	...
	"postalCode\x12,\n" +
	"\rserial_number\x18\b \x01(\tB\a\xbaH\x04r\x02\x10\x00R\fserialNumber\x12(\n" +
	"\vcommon_name\x18\t \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"commonName\x123\n" +
	"\x05names\x18\n" +
